...
export default function NavHero({subHeading, heading, rightSideImage, navBattery, navEasyAnalysis, navElectricMotor, navProducts}){
        console.log(navBattery, navEasyAnalysis, navElectricMotor, navProducts);
              ...
              <div className="sm:text-center md:max-w-2xl md:mx-auto lg:col-span-6 lg:text-left">
                <h1>
                  ...
                  <span className="mt-1 block text-4xl tracking-tight font-extrabold sm:text-5xl xl:text-6xl">
                    <span className="block text-gray-900">Resla</span>
                    <span className="block text-indigo-600">{heading}</span>
                  </span>
                </h1>
              ...
              <div className="mt-12 relative sm:max-w-lg sm:mx-auto lg:mt-0 lg:max-w-none lg:mx-0 lg:col-span-6 lg:flex lg:items-center">
                ...
                <div className="relative mx-auto w-full rounded-lg shadow-lg lg:max-w-md">
                  ...
                  >
                    ...
                    <GatsbyImage className="w-full" image={image} alt="arse"/>
